    ...
    return (
        ...
        >
            <div className="flex items-stretch bg-white border-2 border-black shadow-[6px_6px_0_rgba(0,0,0,1)] max-w-sm w-full">
                <div
                    className={`w-3 ${isError ? "bg-red-500" : "bg-[var(--theme-accent)]"} border-r-2 border-black shrink-0`}
                ></div>
                <div className="flex items-center gap-4 p-4 flex-1">
                    ...
                    <button
                        onClick={onClose}
                        className="text-black hover:text-red-500 p-1 border-2 border-transparent hover:border-black hover:bg-black/5 transition-all shrink-0 cursor-pointer"
                    >
                        <svg
                            className="w-4 h-4"
                            fill="none"
