            ...
            <section className="py-20 relative z-10 overflow-hidden bg-[url('https://dwarf-factory.com/assets/images/bg/light.jpg')] bg-contain">
                <div className="max-w-[1400px] mx-auto px-6">
                    ...
                    <div className="flex flex-col items-center mt-8">
                        <button
                            onClick={() => navigate("/products")}
                            className="h-12 w-fit bg-[var(--theme-accent)] px-5 py-2 items-center gap-2 font-oswald font-bold uppercase tracking-widest text-white hover:-translate-y-1 hover:shadow-[4px_4px_0_rgba(0,0,0,1)] hover:border-2 hover:border-black transition-all cursor-pointer"
                        >
                            EXPLORE NOW
                        </button>
                    </div>
