...
const VendorDashboard = () => {
    ...
    const fetchShop = async () => {
        try {
            ...
            if (!res.ok)
                throw new Error(
                    data.message || "Không thể tải thông tin shop.",
                );
            setShop(data);
            setShopForm({
                name: data.name || "",
    ...
    const fetchProducts = async () => {
        try {
            ...
            const res = await fetch(
                `${API_URL}/api/products?shopId=${shop.id}&allStatus=true`,
                {
                    headers: { Authorization: `Bearer ${token}` },
                },
            );
            ...
            <div className="max-w-7xl mx-auto px-6 py-8 w-full flex-1 flex flex-col md:flex-row gap-8">
                ...
                <aside className="w-full md:w-64 shrink-0 flex flex-col gap-1 bg-white p-4 rounded-2xl border border-gray-100 shadow-sm h-fit">
                    <div className="flex items-center gap-3 px-3 py-4 border-b border-gray-50 mb-4">
                        ...
                        <div>
                            <h2 className="font-extrabold text-sm text-gray-900 truncate max-w-[150px]">
                                {shop?.name}
                            </h2>
                ...
                <section className="flex-1 min-w-0">
                                ...
                                <>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                                        ...
                                        <div className="bg-white p-6 rounded-2xl border border-gray-50 shadow-sm flex flex-col justify-between">
                                            ...
                                            <span className="text-2xl font-black text-amber-500 mt-2">
                                                ⭐{" "}
                                                {Number(
                                                    revenueData?.summary
                                                        ?.rating ||
                                    ...
                                    <div className="bg-white p-6 rounded-2xl border border-gray-50 shadow-sm">
                                        ...
                                        revenueData.chart.length > 0 ? (
                                                    ...
                                                    (c, idx) => {
                                                        ...
                                                        return (
                                                            ...
                                                            >
                                                                ...
                                                                <div
                                                                    style={{
                                                                        height: `${Math.max(percentHeight, 8)}%`,
                                                                    }}
                                                                    className="w-full bg-[#00b14f] hover:bg-green-600 rounded-t-lg transition-all duration-300 shadow-xs"
                                                                />
                                                                <span className="text-[10px] text-gray-400 font-semibold mt-2 select-none truncate max-w-[60px]">
                                                                    {c.period}
                                                                </span>
                                                            </div>
                                                        );
                                            ...
                                            <div className="py-12 text-center text-sm text-gray-400">
                                                Chưa có dữ liệu giao dịch hoàn
                                                thành để thống kê.
                                            </div>
                                        )}
                                    </div>
                        ...
                        <div className="space-y-6">
                            ...
                            {loadingProducts ? (
                                ...
                                <div className="bg-white border border-gray-100 p-12 text-center rounded-2xl shadow-xs text-gray-400 text-sm">
                                    Chưa có sản phẩm nào. Hãy đăng sản phẩm đầu
                                    tiên!
                                </div>
                            ) : (
                                                ...
                                                {products.map((p) => {
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td
                                                                className="p-4 font-bold text-gray-900 truncate max-w-[200px]"
                                                                title={p.title}
                                                            >
                                                                {p.title}
                                                            </td>
                                                            <td className="p-4">
                                                                <div className="font-extrabold text-[#00b14f]">
                                                                    {fmt(
                                                                        p.price,
                                                                    )}
                                                                </div>
                                                            ...
                                                            <td className="p-4">
                                                                <span className="bg-gray-100 text-gray-500 font-bold text-[10px] px-2 py-0.5 rounded-full">
                                                                    {p.category}
                                                                </span>
                                                            </td>
                                                            <td className="p-4">
                                            ...
                                            <tbody className="divide-y divide-gray-50 text-sm">
                                                {orders.map((o) => (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="p-4">
                                                            <span
                                                                className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full ${o.paymentMethod === "vnpay" ? "bg-blue-50 text-blue-600" : "bg-gray-100 text-gray-500"}`}
                                                            >
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="bg-gradient-to-br from-[#00b14f] to-green-600 p-8 rounded-3xl text-white shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
                                ...
                                <div className="text-xs bg-white/10 backdrop-blur-md px-4 py-3 rounded-2xl border border-white/10 max-w-sm">
                                    ...
                                    <p className="text-green-50/80 mt-1 leading-relaxed">
                                        Số tiền sẽ được chuyển thẳng về tài
                                        khoản ngân hàng liên kết của chủ cửa
                                        hàng trong vòng 24h làm việc.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                ...
                                {loadingWallet ? (
                                    ...
                                    <div className="bg-white border border-gray-100 p-12 text-center rounded-2xl text-gray-400 text-sm">
                                                ...
                                                <tbody className="divide-y divide-gray-50 text-sm">
                                                    {walletHistory.map((w) => (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="p-4">
                                                                <span
                                                                    className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${w.type === "credit" ? "bg-green-50 text-green-600" : "bg-red-50 text-red-500"}`}
                                                                >
                                                                    {w.type ===
                                                                    "credit"
                                                                        ? "Cộng tiền"
                                                            ...
                                                            <td
                                                                className={`p-4 font-extrabold ${w.type === "credit" ? "text-green-600" : "text-red-500"}`}
                                                            >
                                                                {w.type ===
                                                                "credit"
                                                                    ? "+"
                                            ...
                                            <tbody className="divide-y divide-gray-50 text-sm">
                                                {coupons.map((c) => (
                                                    ...
                                                    >
                                                        ...
                                                        <td className="p-4">
                                                            <span
                                                                className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase ${c.type === "percent" ? "bg-amber-50 text-amber-600" : "bg-blue-50 text-blue-600"}`}
                                                            >
                                                                {c.type ===
                                                                "percent"
                                                                    ? "Phần trăm"
                            ...
                            {loadingReviews ? (
                                ...
                                <div className="space-y-4">
                                    {reviews.map((r) => (
                                        <div
                                            key={r.id}
                                            className="bg-white p-6 rounded-2xl border border-gray-100 shadow-xs space-y-4 text-left"
                                        >
                                            <div className="flex justify-between items-start gap-4">
                                                <div>
                                                    ...
                                                    <span className="text-[10px] text-gray-400 ml-3 font-semibold">
                                                        {new Date(
                                                            r.createdAt,
                                                        ).toLocaleDateString()}
                                                    </span>
                                            ...
                                            {r.vendorReply ? (
                                                <div className="bg-green-50/50 p-4 rounded-xl border border-green-50 text-sm">
                                                    <p className="font-bold text-[#00b14f] text-xs">
                                                        Phản hồi của shop:
                                                    </p>
                    ...
                    {activeTab === "settings" && (
                        <div className="space-y-6">
                            <h1 className="text-2xl font-extrabold text-gray-900">
                                Cấu hình thông tin gian hàng
                            </h1>

                            <form
                                onSubmit={handleSaveSettings}
                                className="bg-white p-8 rounded-3xl border border-gray-100 shadow-sm space-y-6 text-left max-w-2xl"
                            >
                                {settingsSuccess && (
                ...
                <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-6 backdrop-blur-xs overflow-y-auto">
                    <div className="bg-white rounded-3xl shadow-xl max-w-lg w-full p-8 relative max-h-[90vh] overflow-y-auto">
                        ...
                        >
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-400 mb-1 uppercase tracking-wider">
                                    Hình ảnh (Danh sách URLs cách nhau bởi dấu
                                    phẩy) *
                                </label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="block text-xs font-bold text-gray-400 mb-1 uppercase tracking-wider">
                                    Màu sắc (Cách nhau bởi dấu phẩy - Tùy chọn)
                                </label>
                                <input
                                    type="text"
